...
export default function Pets({ perfil, onVoltar, onAbrirPet }) {
  ...
  async function interagirRapido(registro, tipo) {
    ...
    if (error) {
      setMensagem(error.message || 'Não foi possível interagir com o pet.')
      setProcessandoId(null)
      return
    }
    ...
    setMensagem(
      tipo === 'alimentar'
        ...
        : tipo === 'brincar'
          ...
          : `${data.nome_personalizado || data.pets?.nome} recebeu cuidados.`,
    )
          ...
          <div className="pet-ativo-dados">
            ...
            <div className="pet-ativo-acoes">
              <button
                ...
                onClick={() =>
                  interagirRapido(companheiroAtivo, 'alimentar')
                }
              >
                🍎 Alimentar
              </button>
              ...
              <button
                ...
                disabled={Boolean(processandoId)}
                onClick={() =>
                  interagirRapido(companheiroAtivo, 'brincar')
                }
              >
                🧶 Brincar
              </button>
              ...
              <button
                ...
                disabled={Boolean(processandoId)}
                onClick={() =>
                  interagirRapido(companheiroAtivo, 'cuidar')
                }
              >
                ✨ Cuidar
              </button>
