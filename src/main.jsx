...
if(path==='/'||path.startsWith('/painel-v2')){const{default:PainelInicialV2}=await import('./v2/PainelInicialV2.jsx');root.render(<StrictMode><PainelInicialV2/></StrictMode>);return}
