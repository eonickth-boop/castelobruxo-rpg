    ...
    return (
      ...
      >
        ...
        <section style={{ marginBottom: '36px' }}>
          ...
          >
            {cardsSistema.map((card) => (
              <button
                key={card.titulo}
                type="button"
                onClick={card.ativo ? card.acao : undefined}
                disabled={!card.ativo || carregando}
                style={{
                  minHeight: '210px',
                  padding: '24px',
                  textAlign: 'left',
                  ...
                  background: card.ativo
                    ? 'linear-gradient(180deg, rgba(31,41,34,.98), rgba(17,23,19,.98))'
                    : 'linear-gradient(180deg, rgba(26,31,28,.8), rgba(15,18,16,.8))',
              ...
              >
                ...
                <div>
                  <h3
                    style={{
                      color: card.ativo ? '#e5c16b' : '#9c9278',
                      fontSize: '1.28rem',
                      margin: '0 0 10px',
                    }}
                  >
                  ...
                  <p
                    style={{
                      color: card.ativo ? '#b8c1ba' : '#7b827d',
                      lineHeight: '1.55',
                      margin: 0,
                    }}
                  >
                ...
                <span
                  style={{
                    color: card.ativo ? '#d9c184' : '#777',
                    fontSize: '.88rem',
                    marginTop: '18px',
                  }}
                >
                  {card.ativo ? 'Acessar →' : 'Em breve'}
                </span>
              </button>
            ))}
          </div>
