...
import CompanheiroPublico from '../components/perfil/CompanheiroPublico'
import AlbumPersonagem from '../components/perfil/AlbumPersonagem'
...
export default function PerfilPublico({
  ...
  function renderizarPerfil(
    ...
    const banner = normalizarUrl(
      configExibida.banner_url || perfilExibido.banner_url,
    )
    ...
    return (
      <>
        ...
        <AlbumPersonagem usuarioId={perfilExibido.id} />
