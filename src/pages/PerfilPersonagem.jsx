    ...
    <main className="perfil-personagem-pagina">
      ...
      <section className="perfil-caderno">
        ...
        <section className="perfil-atalhos">
          ...
          <button type="button" onClick={onAbrirConquistas}>
            🏆 Conquistas
          </button>
          <button type="button" onClick={onAbrirCertificados}>
            📜 Certificados
          </button>
          <button type="button" onClick={onAbrirMissoes}>
            🗺️ Missões
          </button>
          <button type="button" onClick={onAbrirEventos}>
            📅 Eventos
          </button>
          <button type="button" onClick={onAbrirMapa}>
            🗺 Mapa Interativo
          </button>

          <button type="button" onClick={onAbrirUploadsPerfil}>
            🖼️ Imagens do Perfil
          </button>
          <button type="button" onClick={onAbrirCorreio}>
            ✉ Correio Mágico
          </button>
        </section>
