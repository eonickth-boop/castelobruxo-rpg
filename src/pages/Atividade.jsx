...
export default function Atividade({
  ...
  const progresso =
    atividades.length > 0
      ? (totalRespondidas / atividades.length) * 100
      : 0
  ...
  if (resultado) {
    ...
    return (
      <main className="atividade-pagina">
        ...
        >
          <span className="atividade-resultado-icone">
            {aprovado ? '✓' : '↻'}
          </span>
          ...
          <div className="resultado-nota">
            <strong>
              {Number(resultado.nota ?? 0).toFixed(0)}%
            </strong>
            <span>
    ...
    <main className="atividade-pagina">
      ...
      <section className="atividade-progresso">
        <div className="atividade-progresso-cabecalho">
          <span>
            {totalRespondidas} de {atividades.length}{' '}
            respondidas
          </span>
